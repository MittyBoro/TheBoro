...
<style lang="scss">
.bg-box {
  @apply relative shadow-xl shadow-gray-950 rounded-2xl p-8 bg-gradient-to-br from-gray-950 overflow-hidden transition;
  &::after {
    content: "";

    @apply shadow-2xl shadow-gray-600 absolute inset-0 pointer-events-none;
  }
  &.hover {
    &::before {
      content: "";
...
.btn-alt {
  ...
  &:hover {
    @apply bg-gray-100 border-gray-100 shadow-xl shadow-gray-700 text-primary-600 -translate-y-1;
  }
}
</style>
